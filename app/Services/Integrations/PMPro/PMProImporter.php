...
class PMProImporter extends BaseImporter
{
        ...
        return [
            ...
            'fields' => [
                'import_type'     => [
                    ...
                    'help'    => 'Please select import by Membership Level',
                    'type'    => 'input-radio',
                    'options' => [
                        [
                            'id'    => 'membership_level',
                            'label' => 'Import By Membership Level'
                        ]
                    ]
                ],
                'level_type_maps' => [
                    'label'              => 'Please map your Membership Levels and associate FluentCRM Tags',
    ...
    private function getUserIdsByResourceIds($levelIds, $limit, $offset)
    {
        ...
        $enrollments = wpFluent()->table('pmpro_memberships_users')
            ->select(['user_id'])
            ->where('status', 'active')
