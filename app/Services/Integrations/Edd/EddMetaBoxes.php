...
class EddMetaBoxes
{
    public function init()
    {
        ...
        add_action('edd_download_price_option_row', array($this, 'perPriceMetaBox'), 10, 2);
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <select id="fluentcrm_add_tags_member_type" placeholder="Select Tags" style="width:100%;"
                    ...
                    <span class="description">Apply these tags when purchased</span>
    ...
    public function perPriceMetaBox($postId, $key)
    {
        ...
        <div style="padding: 10px 20px;">
            <input type="hidden" value="yes" name="_has_fcrm"/>
            <span class="edd-custom-price-option-section-title">FluentCRM Settings</span>
            <div>
                ...
                <span class="description">Apply these tags when purchase this variation</span>
    ...
    private function getTagIdsFromPayment($payment, $scope = 'success')
    {
        ...
        foreach($payment->cart_details as $item) {
            ...
            if (isset($item['item_number'])) {
                $priceId = \FluentCrm\Includes\Helpers\Arr::get($item, 'item_number.options.price_id');
                if (!$priceId) {
                    continue;
                }
                $priceTags = \FluentCrm\Includes\Helpers\Arr::get($settings, 'attach_tag_prices.' . $priceId, []);
