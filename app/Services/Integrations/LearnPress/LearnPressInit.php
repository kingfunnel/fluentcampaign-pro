...
class LearnPressInit
{
    ...
    {
        $content['heading'] = 'LearnPress Courses';
        ...
        $enrollments = wpFluent()->table('learnpress_user_items')
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    ...
                    <select id="fluentcrm_add_enroll_tags" placeholder="Select Tags" style="width:100%;"
                    ...
                    <span class="description">Apply these tags on course enrollment</span>
                </td>
            </tr>
            <tr>
                <th><label
                ...
                <td>
                    <select id="fluentcrm_add_completed_tags" placeholder="Select Tags" style="width:100%;"
                            class="fc_multi_select"
                    ...
                    <span class="description">Apply these tags on course completion</span>
                </td>
            </tr>
        </table>
        <?php
