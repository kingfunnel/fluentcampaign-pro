...
class BBMemberType
{
    ...
    <?php endif; ?>
        <tr>
            ...
            <td>
                ...
                <p>Selected tags will be added to the member on joining this member type</p>
    ...
    public function platFormBox($post)
    {
        ...
        if ($term) {
            ...
            echo '<p>Please add at least one member to this Member type to add FluentCRM Tag Settings</p>';
        }
    }
