...
class BbImporter extends BaseImporter
{
        ...
        return [
            ...
            'fields' => [
                'import_type'        => [
                    ...
                    'help'    => 'Please select Member Type or Member group that you want to import',
                    'type'    => 'input-radio',
                    'options' => [
                        [
                            'id'    => 'member_type',
                            'label' => 'Import By Member Type'
                        ],
                        [
                            'id'    => 'bp-groups',
                            'label' => 'Import By Member Groups'
                        ]
                    ]
                ],
                'member_type_maps'   => [
                    'label'              => 'Please map your Member Type and associate FluentCRM Tags',
                ...
                'member_groups_maps' => [
                    'label'              => 'Please map your Group and associate FluentCRM Tags',
                    'type'               => 'form-many-drop-down-mapper',
    ...
    {
        $query = wpFluent()->table('bp_groups_members')
            ->select(['user_id'])
            ->groupBy('user_id')
